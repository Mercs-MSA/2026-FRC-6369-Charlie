...
import frc.robot.subsystems.drive.Drive.Controllers.HolonomicControllerProfiled;
// import frc.robot.subsystems.drive.Drive.Controllers.DriveToPoseController;
import frc.robot.subsystems.drive.Drive.Controllers.PointAndDriveController;
import frc.robot.subsystems.drive.Drive.Controllers.TeleopController;
...
public class Drive extends SubsystemBase {
  ...
  public DriveState driveState = DriveState.TELEOP;
  ...
  private HolonomicController holonomicController = new HolonomicController();
  private TeleopController teleopController = new TeleopController(this);
  private final HolonomicControllerProfiled holonomicControllerProfiled =
      new HolonomicControllerProfiled();

  private final PointAndDriveController PointAndDriveController = new PointAndDriveController();
  ...
  public void setSuppliedPose(Supplier<Pose2d> poseSupplier) {
  ...
  public Command setDriveStateCommandContinued(DriveState state) {
    return new FunctionalCommand(
        () -> setDriveState(state), () -> {}, (interrupted) -> {}, () -> false, this);
  }
  ...
  public void setDriveState(DriveState state) {
    ...
    switch (driveState) {
      case DRIVETOPOSEPROFILED:
        holonomicControllerProfiled.reset(
            getPose(),
      ...
      case POINTANDDRIVE:
        ...
        goalPose = new Pose2d(5.0, 5.0, new Rotation2d());
        break;
  ...
  public void acceptJoystickInputs(
    ...
    PointAndDriveController.acceptJoystickInputs(xSupplier, ySupplier);
  }
