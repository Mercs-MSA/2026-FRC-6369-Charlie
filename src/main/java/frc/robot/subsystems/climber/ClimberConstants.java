...
public class ClimberConstants {
  public static final double kRotorRotationsToMeters = 1;
  public static final double kMaxPositionMeters = 220.0;
  public static final double kMinPositionMeters = 0.0;
  public static final double kPositionToleranceRadians = 0.08;
  public static final double kGearingRatioSensorToMechanism = 1;
  public static final double kRotorOffset = 0.189453125;
