...
public class IndexIOTalonFX implements IndexIO {
  ...
  public IndexIOTalonFX(
      IndexConstants.IndexHardware hardware,
      IndexConstants.IndexMotorConfiguration configuration,
      IndexConstants.IndexGains gains) {
    ...
    BaseStatusSignal.setUpdateFrequencyForAll(
        IndexConstants.kStatusSignalUpdateFrequencyHz,
        velocity,
        appliedVolts,
        supplyCurrentAmps,
        statorCurrentAmps,
