...
public class ShooterMathProvider {
    ...
    public ShooterMathProvider() {
        ...
        shotMapRPS.put(2.6924, new Double[]{45.0, 0.012});
        shotMapRPS.put(3.6322, new Double[]{51.5, 0.033});
        shotMapRPS.put(3.9878, new Double[]{52.0, 0.016});
        shotMapRPS.put(4.71805, new Double[]{58.5, 0.029});
